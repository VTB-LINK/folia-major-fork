...
export default {
  ...
  "options": {
    ...
    "obsAiKeyLeakWarning": "OBS “Dynamic · AI” mode writes this AI key into the copied OBS URL; don't share it publicly or on stream — use it only within your own OBS.",
