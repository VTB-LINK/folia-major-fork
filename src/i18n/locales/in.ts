export default {
  ...
  "options": {
    ...
    "obsAiKeyLeakWarning": "Mode OBS “Dinamis · AI” menulis kunci AI ini ke URL OBS yang disalin; jangan bagikan secara publik atau saat streaming — gunakan hanya di dalam OBS Anda sendiri.",
